...
binary_difficulty_eval = """
Evaluate the difficulty of using the given numbers and basic arithmetic operations (+ - * /) to obtain 24 (Hard/Easy).
Please do not restate the question, do not derive in any way other than the following example.
6 4 1 1
6 * 4 * 1 * 1 = 24
Easy
